## Current Pending Requirement List (when Fullfillment is 100% this page will be empty):
...
- **Part 2 b JSON/XML to machine code (input)
- **Part 2 c machine code to JSON/XML (output)
- **Part 3 User Manual (OS) TT Tree Transport 
- **Part 4 FPGA RTL CC - implementation showing the PwPI SEED (logic injected into the systolica array in real time)
